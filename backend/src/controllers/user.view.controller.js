...
const getConnectionRequest=async(req,res)=>{
    try{
        ...
        .populate("fromUserId", ["firstname", "lastname", "skills","photoUrl","AboutUs","age","gender","photoUrl"])
        .populate("toUserId", ["firstname", "lastname", "skills","photoUrl","AboutUs","age","gender","photoUrl"]);
